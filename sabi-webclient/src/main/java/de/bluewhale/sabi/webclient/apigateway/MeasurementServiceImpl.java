...
public class MeasurementServiceImpl extends APIServiceImpl implements MeasurementService {
    ...
    @Override
    public ParameterTo getParameterFor(Integer selectedUnitId, String pJWTBackendAuthtoken) throws BusinessException {
    ...
    @Override
    public @NotNull List<MeasurementTo> getMeasurementsTakenByUser(@NotNull String pJWTBackendAuthtoken, @NotNull Integer maxResultCount) throws BusinessException {
    ...
    @Override
    public @NotNull List<MeasurementTo> getMeasurementsForUsersTank(@NotNull String pJWTBackendAuthtoken, @NotNull Long tankId) throws BusinessException {
    ...
    @Override
    public List<MeasurementTo> getMeasurementsForUsersTankFilteredByUnit(String pJWTBackendAuthtoken, Long tankId, Integer unitId) throws BusinessException {
    ...
    @Override
    public void deleteMeasurementById(@NotNull Long measurementId, @NotNull String pJWTBackendAuthtoken) throws BusinessException {
