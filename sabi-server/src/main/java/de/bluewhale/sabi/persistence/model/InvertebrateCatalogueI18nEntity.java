...
/**
 * Localised fields for an invertebrate catalogue entry (one per language).
...
public class InvertebrateCatalogueI18nEntity extends Auditable {
    ...
    private InvertebrateCatalogueEntity catalogue;
}
